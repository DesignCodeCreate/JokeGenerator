<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <form action="https://api.staticforms.xyz/submit" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <input type="text" name="subject" id="subject" autocomplete="organization" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        <div class="sm:col-span-2">
