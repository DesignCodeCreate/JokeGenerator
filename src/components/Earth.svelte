...
<div style="z-index:1" class="absolute mt-[-30%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
    <div style="background-color: rgba(9, 43, 91, 0.7);" class="rounded-xl  p-8 mb-4 bg-[#00000] opacity-1">
        <div>
